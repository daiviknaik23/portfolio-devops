...
export const education = [
  ...
  },
  {
    ...
    institution: "Premier College of Science and Commerce, Karwar, Karnataka",
    year: "",
    grade: "Percentage: 84%",
  ...
  },
  {
    ...
    institution: "Kendriya Vidyalaya, Karwar, Karnataka",
    year: "",
    grade: "Percentage: 75%",
...
export const achievements = [
  "Successfully designed and deployed a cloud-native portfolio platform using AWS S3, CloudFront, Route53, Jenkins CI/CD, Docker, Kubernetes, Prometheus, Grafana, and Better Stack monitoring.",
  "Implemented end-to-end DevOps automation by integrating GitHub, Jenkins, Ansible, AWS, and automated deployment workflows for continuous delivery.",
  "Participated in Google DevFest 2024 and explored emerging trends in Artificial Intelligence, Cloud Computing, and Modern Software Development practices.",
  "Participated in multiple hackathons, coding competitions, and technical events, strengthening problem-solving, collaboration, and rapid product development skills.",
  "Built and deployed an AI-powered Finance Tracking Platform integrating Gemini AI, Supabase, Prisma ORM, Clerk Authentication, and automated financial reporting.",
];
...
export const certifications = [
  {
    title: "Practical AWS for DevOps: Exploring AWS DevOps Services",
